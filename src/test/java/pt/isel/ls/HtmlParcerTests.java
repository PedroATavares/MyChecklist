...
public class HtmlParcerTests {
    ...
    public void test_checklist_List_parce(){
        ...
        assertEquals("<html  ><h2  >Checklist</h2><p  >Id: 10</p><p  >Name: Checklist 1</p><p  >" +
                "Description: Descricao 1</p><p  >Due date: 2015-10-10</p><p  ><a  href= \"/templates/2\", >" +
                "Template Id:2</a></p><p  >Is Closed: true</p><h3  >Tasks</h3><table  style= \"width:50%\", border= \"1\", ><tr  ><td  >Id</td><td  >" +
                "CheckList Id</td><td  >Name</td><td  >Descricao</td><td  >Due Date</td><td  >Is Closed</td></tr><tr  ><td  >1</td><td  >10</td><td  >" +
                "Task 1</td><td  >Descricao 1</td><td  >2015-10-10</td><td  ><form  action= \"/checklists/10/tasks/1\", method= \"post\", >" +
                "<input  type= \"submit\", value= \"False\", ></input><input  type= \"hidden\", name= \"isClosed\", value= \"true\", ></input>" +
                "<input  type= \"hidden\", name= \"reload\", value= \"/checklists/10\", ></input></form></td></tr><tr  ><td  >2</td>" +
                "<td  >10</td><td  >Task 2</td><td  >Descricao 2</td><td  >2015-5-12</td><td  ><form  action= \"/checklists/10/tasks/2\", method= \"post\", >" +
                "<input  type= \"submit\", value= \"True\", ></input><input  type= \"hidden\", name= \"isClosed\", value= \"false\", ></input>" +
                "<input  type= \"hidden\", name= \"reload\", value= \"/checklists/10\", ></input></form></td></tr><tr  ><td  >3</td><td  >10</td>" +
                "<td  >Task 3</td><td  >Descricao 3</td><td  >2016-12-11</td><td  ><form  action= \"/checklists/10/tasks/3\", method= \"post\", >" +
                "<input  type= \"submit\", value= \"False\", ></input><input  type= \"hidden\", name= \"isClosed\", value= \"true\", ></input>" +
                "<input  type= \"hidden\", name= \"reload\", value= \"/checklists/10\", ></input></form></td></tr></table>" +
                "<form  action= \"/checklists/10/tasks\", method= \"post\", ><br  >Name:</br><input  type= \"text\", name= \"name\", >" +
                "</input><br  >Description:</br><input  type= \"text\", name= \"description\", ></input><br  >" +
                "Due Date in format yyyy-mm-dd:</br><input  type= \"text\", name= \"dueDate\", ></input>" +
                "<input  type= \"hidden\", name= \"reload\", value= \"/checklists/10\", ></input><input  type= \"submit\", value= \"Submit\", >" +
                "</input></form><h3  >Tags</h3><table  style= \"width:50%\", border= \"1\", ><tr  ><th  >Id</th><th  >Name</th><th  >Color</th>" +
                "<th  >Checklist of Tag</th></tr><tr  ><td  >1</td><td  ><a  href= \"/tags/1\", >Tag 1</a></td><td  >A</td><td  >" +
                "<a  href= \"/tags/1/checklists\", >Link</a></td></tr></table><form  action= \"/checklists/10/tags\", method= \"post\", >" +
                "<br  >Gid:</br><input  type= \"text\", name= \"gid\", ></input><input  type= \"hidden\", name= \"reload\", value= \"/checklists/10\", >" +
                "</input><input  type= \"submit\", value= \"Submit\", ></input></form><h3  ><a  href= \"./\", >Back</a></h3><h3  ><a  href= \"/\", >" +
                "Home</a></h3></html>",ex1.supply(cl).toString());
    }
    ...
    public void test_tag_parce(){
        ...
        assertEquals("<html  ><body  ><h3  >TAG</h3><p  >Id: 1</p><p  >" +
                "Name: Frutas</p><p  >Color: Black</p><h3  >" +
                "Checklists: </h3><table  style= \"width:50%\", border= \"1\", ><tr  ><th  >" +
                "Id</th><th  >Template Id</th><th  >Name</th><th  >Description</th><th  >" +
                "Due Date</th><th  >Is Closed</th></tr><tr  ><td  >10</td><td  >None</td><td  >" +
                "<a  href= \"/checklists/10\", >Checklist 1</a></td><td  >Descricao 1</td><td  >" +
                "2015-10-10</td><td  >true</td></tr><tr  ><td  >10</td><td  >None</td><td  >" +
                "<a  href= \"/checklists/10\", >Checklist 1</a></td><td  >Descricao 1</td><td  >" +
                "2015-10-10</td><td  >true</td></tr></table><h3  ><a  href= \"/tags/1/checklists\", >" +
                "CheckLists of Tag</a></h3><h3  ><a  href= \"/tags\", >Back</a></h3><h3  ><a  " +
                "href= \"/\", >Home</a></h3></body></html>"
    ...
    public void test_template_parce(){
        ...
        assertEquals("<html  ><body  ><table  style= \"width:50%\", border= \"1\", ><tr  ><h3  >TEMPLATE</h3><th  >Id</th>" +
                        "<th  >Name</th><th  >Description</th></tr><tr  ><td  >1</td><td  ><a  href= \"/templates/1\", >" +
                        "Template 1</a></td><td  >Este e o template 1.</td></tr><tr  ><td  >1</td><td  ><a  href= \"/templates/1\", >" +
                        "Template 1</a></td><td  >Este e o template 1.</td></tr></table><form  action= \"/templates\", method= \"post\", " +
                        "><br  >Name:</br><input  type= \"text\", name= \"name\", ></input><br  >Description:</br><input  type= \"text\", " +
                        "name= \"description\", ></input><input  type= \"hidden\", name= \"dest\", value= \"/templates/\", ></input>" +
                        "<input  type= \"submit\", value= \"Submit\", ></input></form><h3  ><a  href= \"/checklists\", >CheckLists</a>" +
                        "</h3><h3  ><a  href= \"/\", >Home</a></h3></body></html>",

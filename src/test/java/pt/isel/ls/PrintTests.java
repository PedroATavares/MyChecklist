...
public class PrintTests {
    ...
    public void test_CheckListtoString(){
        ...
        CheckList cl = new CheckList(5, "Lista de Compras", "Lista de compras para o frigorifico da Dona Fatima", "22-5-2017",4,tasks);
    ...
    public void test_CheckListtoString_WithEmptyFields(){
        ...
        CheckList cl = new CheckList(5, "Lista de Compras", "Lista de compras para o frigorifico da Dona Fatima", "22-5-2017",null,tasks);
        System.out.println(cl);
    }
    @Test
